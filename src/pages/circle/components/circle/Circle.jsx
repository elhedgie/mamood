    ...
    <main className={style.main}>
      <section className={style.contentBlock}>
        <ul className={style.emoList}>
          <li className={style.emoItem}>
            <h2
              ...
              className={[style.emoHeading, style.purple].join(" ")}
            >
              Фиолетовый
            </h2>
            <ul className={style.innerList}>
              <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                Отвращение
              </InnerItem>
              <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                Неудовольствие
          ...
          <li className={style.emoItem}>
            <h2
              onClick={accordionHandler}
              className={[style.emoHeading, style.blue].join(" ")}
            >
              Голубой
            </h2>
            <ul className={style.innerList}>
          ...
          <li className={style.emoItem}>
            <h2
              onClick={accordionHandler}
              className={[style.emoHeading, style.green].join(" ")}
            >
              Зелёный
            </h2>
            <ul className={style.innerList}>
        ...
        <div className={style.circleWrapper}>
          ...
          <p>
            Помоги себе обнаружить свою эмоцию и нажми на нее, чтобы прочитать
            подробнее
          </p>
            ...
            <svg className={style.chart} width="700" height="700">
              ...
              <foreignObject x="430" y="330" width="300" height="300">
                <ul
                  ...
                  className={[style.listGreen, style.list].join(" ")}
                >
                  <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                    Любовь
                  </InnerItem>
              ...
              <foreignObject x="275" y="470" width="300" height="300">
                <ul
                  ...
                  onMouseLeave={mouseLeaveHandler}
                  onMouseOver={mouseHandler}
                  className={[style.listLightGreen, style.list].join(" ")}
                >
                  <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                    Ужас
                  </InnerItem>
              ...
              <foreignObject x="50" y="450" width="300" height="300">
                <ul
                  ...
                  onMouseLeave={mouseLeaveHandler}
                  onMouseOver={mouseHandler}
                  className={[style.listBlue, style.list].join(" ")}
                >
                  <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                    Изумление
                  </InnerItem>
              ...
              <foreignObject x="-20" y="260" width="300" height="300">
                <ul
                  ...
                  onMouseLeave={mouseLeaveHandler}
                  onMouseOver={mouseHandler}
                  className={[style.listLightBlue, style.list].join(" ")}
                >
                  <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                    Горе
                  </InnerItem>
              ...
              <foreignObject x="-35" y="120" width="300" height="300">
                <ul
                  ...
                  onMouseLeave={mouseLeaveHandler}
                  onMouseOver={mouseHandler}
                  className={[style.listPurple, style.list].join(" ")}
                >
                  <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                    Неудовольствие
                  </InnerItem>
              ...
              <foreignObject x="80" y="0" width="300" height="300">
                <ul
                  ...
                  onMouseLeave={mouseLeaveHandler}
                  onMouseOver={mouseHandler}
                  className={[style.listRed, style.list].join(" ")}
                >
                  <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                    Агрессия
                  </InnerItem>
              ...
              <foreignObject x="235" y="10" width="300" height="300">
                <ul
                  ...
                  onMouseLeave={mouseLeaveHandler}
                  onMouseOver={mouseHandler}
                  className={[style.listOrange, style.list].join(" ")}
                >
                  <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                    Настороженность
                  </InnerItem>
              ...
              <foreignObject x="380" y="100" width="300" height="300">
                <ul
                  ...
                  onMouseLeave={mouseLeaveHandler}
                  onMouseOver={mouseHandler}
                  className={[style.listYellow, style.list].join(" ")}
                >
                  <InnerItem popupOpen={popupOpen} className={style.innerItem}>
                    Безмятежность
                  </InnerItem>
        ...
        <ul className={[style.emoList, style.secondList].join(" ")}>
          <li className={style.emoItem}>
            <h2
              onClick={accordionHandler}
              className={[style.emoHeading, style.red].join(" ")}
            >
              Красный
            </h2>
            <ul className={style.innerList}>
          ...
          <li className={style.emoItem}>
            <h2
              onClick={accordionHandler}
              className={[style.emoHeading, style.orange].join(" ")}
            >
              Оранжевый
            </h2>
            <ul className={style.innerList}>
          ...
          <li className={style.emoItem}>
            <h2
              onClick={accordionHandler}
              className={[style.emoHeading, style.yellow].join(" ")}
            >
              Жёлтый
            </h2>
            <ul className={style.innerList}>
      ...
      <div onClick={popupClose} className={style.popup}>
        <div className={style.popupBlock}>
          ...
          <div className={style.info}>
            <p>
              <span style={{ color: "purple" }}>Функция: </span>
              {popupValue.function}
            </p>
            <p>
              <span style={{ color: "purple" }}>Триггеры: </span>
              {popupValue.trigger}
            </p>
            <p>
              <span style={{ color: "purple" }}>Мысли: </span>
              {popupValue.thoughts}
            </p>
            <p>
              <span style={{ color: "purple" }}>Симптомы: </span>
              {popupValue.symptoms}
            </p>
            <p>
              Я принимаю это чувство, потому что разрешаю себе испытывать любые
              эмоции.
            </p>
          </div>
        </div>
